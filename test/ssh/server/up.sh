#!/usr/bin/env bash
# Bring up all DESPOT SSH test endpoints and print a per-endpoint cheat
...
if [[ ! -f "${CLIENT_KEY}" ]]; then
    ...
    ssh-keygen -q -t ed25519 -f "${CLIENT_KEY}" -N "" -C "despot-test"
fi
...
=========================================================================
 DESPOT SSH test endpoints are UP. Target host: ${LAN_IP}

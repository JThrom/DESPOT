...
// Tokenize a command line into argv, honoring double and single quotes so
// that arguments containing spaces (e.g. a Wi-Fi SSID like "My Network") are
// kept as a single token. Quotes are stripped; a backslash escapes the next
// character. Tokens are built in-place inside `buf`.
static int tokenize_command(char *buf, char **argv, int max_args) {
    int argc = 0;
    char *rd = buf;   // read cursor
    while (*rd && argc < max_args) {
        // Skip leading separators (spaces / tabs).
        while (*rd == ' ' || *rd == '\t') rd++;
        if (!*rd) break;

        char *wr = rd;        // write cursor for the compacted token
        char *tok = wr;       // start of this token
        ...
        while (*rd) {
            ...
            if (quote) {
                if (c == quote) {
                    quote = 0;
                    rd++;
                } else if (c == '\\' && quote == '"' && rd[1]) {
                    // Allow \" and \\ inside double quotes.
                    rd++;
                    *wr++ = *rd++;
                } else {
                    *wr++ = *rd++;
                ...
                *wr++ = *rd++;
                ...
                // Consume the separator BEFORE terminating the token, so the
                // outer separator-skip resumes past it. (When wr == rd the
                // terminator would otherwise overwrite this separator and stall
                // the scan on the very next token.)
                rd++;
                break;
            } else {
                *wr++ = *rd++;
...
static void execute_command(const char *line) {
    ...
    int argc = tokenize_command(buf, argv, CMD_MAX_ARGS);
    if (argc == 0) return;
...
static void cmd_about_handler(int argc, char **argv) {
    ...
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8\033[38;2;206;38;255m8\033[38;2;194;38;255m8\033[38;2;181;38;255m8\033[38;2;169;38;255m8\033[38;2;157;38;255mb\033[38;2;145;38;255m.   \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8\033[38;2;59;38;255m8\033[38;2;47;38;255m8\033[38;2;38;41;255m8\033[38;2;38;53;255m8\033[38;2;38;65;255m8\033[38;2;38;77;255m8\033[38;2;38;89;255m8   \033[38;2;38;138;255m.\033[38;2;38;150;255md\033[38;2;38;163;255m8\033[38;2;38;175;255m8\033[38;2;38;187;255m8\033[38;2;38;199;255m8\033[38;2;38;211;255mb\033[38;2;38;224;255m.   \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8\033[38;2;38;255;200m8\033[38;2;38;255;188m8\033[38;2;38;255;176m8\033[38;2;38;255;163m8\033[38;2;38;255;151mb\033[38;2;38;255;139m.    \033[38;2;38;255;78m.\033[38;2;38;255;66md\033[38;2;38;255;54m8\033[38;2;38;255;42m8\033[38;2;46;255;38m8\033[38;2;58;255;38m8\033[38;2;71;255;38m8\033[38;2;83;255;38mb\033[38;2;95;255;38m.   \033[38;2;144;255;38m8\033[38;2;156;255;38m8\033[38;2;168;255;38m8\033[38;2;180;255;38m8\033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8\033[38;2;229;255;38m8\033[38;2;241;255;38m8\033[38;2;254;255;38m8\033[38;2;255;243;38m8     " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8   \033[38;2;169;38;255mY\033[38;2;157;38;255m8\033[38;2;145;38;255m8\033[38;2;133;38;255mb  \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8         \033[38;2;38;126;255md\033[38;2;38;138;255m8\033[38;2;38;150;255m8\033[38;2;38;163;255mP  \033[38;2;38;199;255mY\033[38;2;38;211;255m8\033[38;2;38;224;255m8\033[38;2;38;236;255mb  \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8   \033[38;2;38;255;163mY\033[38;2;38;255;151m8\033[38;2;38;255;139m8\033[38;2;38;255;127mb  \033[38;2;38;255;90md\033[38;2;38;255;78m8\033[38;2;38;255;66m8\033[38;2;38;255;54mP\033[38;2;38;255;42m\" \033[38;2;58;255;38m\"\033[38;2;71;255;38mY\033[38;2;83;255;38m8\033[38;2;95;255;38m8\033[38;2;107;255;38mb      \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8    \033[38;2;157;38;255m8\033[38;2;145;38;255m8\033[38;2;133;38;255m8  \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8         \033[38;2;38;126;255mY\033[38;2;38;138;255m8\033[38;2;38;150;255m8\033[38;2;38;163;255mb\033[38;2;38;175;255m.       \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8    \033[38;2;38;255;151m8\033[38;2;38;255;139m8\033[38;2;38;255;127m8  \033[38;2;38;255;90m8\033[38;2;38;255;78m8\033[38;2;38;255;66m8     \033[38;2;83;255;38m8\033[38;2;95;255;38m8\033[38;2;107;255;38m8      \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8    \033[38;2;157;38;255m8\033[38;2;145;38;255m8\033[38;2;133;38;255m8  \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8\033[38;2;59;38;255m8\033[38;2;47;38;255m8\033[38;2;38;41;255m8\033[38;2;38;53;255m8      \033[38;2;38;138;255m\"\033[38;2;38;150;255mY\033[38;2;38;163;255m8\033[38;2;38;175;255m8\033[38;2;38;187;255m8\033[38;2;38;199;255mb\033[38;2;38;211;255m.    \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8   \033[38;2;38;255;163md\033[38;2;38;255;151m8\033[38;2;38;255;139m8\033[38;2;38;255;127mP  \033[38;2;38;255;90m8\033[38;2;38;255;78m8\033[38;2;38;255;66m8     \033[38;2;83;255;38m8\033[38;2;95;255;38m8\033[38;2;107;255;38m8      \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8    \033[38;2;157;38;255m8\033[38;2;145;38;255m8\033[38;2;133;38;255m8  \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8             \033[38;2;38;175;255m\"\033[38;2;38;187;255mY\033[38;2;38;199;255m8\033[38;2;38;211;255m8\033[38;2;38;224;255mb\033[38;2;38;236;255m.  \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8\033[38;2;38;255;200m8\033[38;2;38;255;188m8\033[38;2;38;255;176m8\033[38;2;38;255;163m8\033[38;2;38;255;151mP\033[38;2;38;255;139m\"   \033[38;2;38;255;90m8\033[38;2;38;255;78m8\033[38;2;38;255;66m8     \033[38;2;83;255;38m8\033[38;2;95;255;38m8\033[38;2;107;255;38m8      \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8    \033[38;2;157;38;255m8\033[38;2;145;38;255m8\033[38;2;133;38;255m8  \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8               \033[38;2;38;199;255m\"\033[38;2;38;211;255m8\033[38;2;38;224;255m8\033[38;2;38;236;255m8  \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8         \033[38;2;38;255;90m8\033[38;2;38;255;78m8\033[38;2;38;255;66m8     \033[38;2;83;255;38m8\033[38;2;95;255;38m8\033[38;2;107;255;38m8      \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8   \033[38;2;169;38;255md\033[38;2;157;38;255m8\033[38;2;145;38;255m8\033[38;2;133;38;255mP  \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8         \033[38;2;38;126;255mY\033[38;2;38;138;255m8\033[38;2;38;150;255m8\033[38;2;38;163;255mb  \033[38;2;38;199;255md\033[38;2;38;211;255m8\033[38;2;38;224;255m8\033[38;2;38;236;255mP  \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8         \033[38;2;38;255;90mY\033[38;2;38;255;78m8\033[38;2;38;255;66m8\033[38;2;38;255;54mb\033[38;2;38;255;42m. \033[38;2;58;255;38m.\033[38;2;71;255;38md\033[38;2;83;255;38m8\033[38;2;95;255;38m8\033[38;2;107;255;38mP      \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    shell_print("\r\n  " " \033[38;2;242;38;255m8\033[38;2;230;38;255m8\033[38;2;218;38;255m8\033[38;2;206;38;255m8\033[38;2;194;38;255m8\033[38;2;181;38;255m8\033[38;2;169;38;255m8\033[38;2;157;38;255mP\033[38;2;145;38;255m\"   \033[38;2;96;38;255m8\033[38;2;84;38;255m8\033[38;2;72;38;255m8\033[38;2;59;38;255m8\033[38;2;47;38;255m8\033[38;2;38;41;255m8\033[38;2;38;53;255m8\033[38;2;38;65;255m8\033[38;2;38;77;255m8\033[38;2;38;89;255m8   \033[38;2;38;138;255m\"\033[38;2;38;150;255mY\033[38;2;38;163;255m8\033[38;2;38;175;255m8\033[38;2;38;187;255m8\033[38;2;38;199;255m8\033[38;2;38;211;255mP\033[38;2;38;224;255m\"   \033[38;2;38;255;237m8\033[38;2;38;255;224m8\033[38;2;38;255;212m8          \033[38;2;38;255;78m\"\033[38;2;38;255;66mY\033[38;2;38;255;54m8\033[38;2;38;255;42m8\033[38;2;46;255;38m8\033[38;2;58;255;38m8\033[38;2;71;255;38m8\033[38;2;83;255;38mP\033[38;2;95;255;38m\"       \033[38;2;193;255;38m8\033[38;2;205;255;38m8\033[38;2;217;255;38m8         " TN_RESET);
    ...
    // Tagline.
    shell_print("\r\n  " TN_MUTED "  Dumb Esp32 Secure Portable Open Terminal \xe2\x80\xa2 SSH over Wi-Fi + Tailscale" TN_RESET);

    // DEVICE
    about_section(TN_ORANGE, "DEVICE");
    #if CONFIG_IDF_TARGET_ESP32P4
    #if CONFIG_DESPOT_BOARD_CROWPANEL_ADV_9
    about_row(TN_ORANGE, "Product", "CrowPanel Advanced 9\" ESP32-P4 HMI");
    #else
    ...
    about_row(TN_ORANGE, "GitHub", "https://github.com/JThrom/DESPOT");
    about_row(TN_ORANGE, "License", "GNU/GPL v2");
    #if CONFIG_IDF_TARGET_ESP32P4
    #if CONFIG_DESPOT_BOARD_CROWPANEL_ADV_9
    static const char *panel_label = "9\" IPS MIPI panel";
    #else
    static const char *panel_label = "7\" MIPI panel";
    #endif
    #else
    static const char *panel_label = "7\" RGB panel";
    #endif
    if (term) {
        char display_val[96];
        snprintf(display_val, sizeof(display_val),
                 "%s \xe2\x80\xa2 grid %dx%d \xe2\x80\xa2 cell %dx%d",
                 panel_label, term->cols, term->rows, term->font_w, term->font_h);
        about_row(TN_ORANGE, "Display", display_val);
    } else {
        about_row(TN_ORANGE, "Display", panel_label);
    }
    #if CONFIG_DESPOT_BOARD_CROWPANEL_ADV_9
    about_row(TN_ORANGE, "I/O expander", "none (CrowPanel)");
    #else
    ...
    about_row(TN_PURPLE, "Keyboard", "BLE HID");
...
// Display backlight brightness persistence (NVS "devicecfg"/"blpct", 0-100 u8).
// The slider (ui_status_menu.cpp) calls brightness_save() when the user changes
// it; brightness_load() re-applies the saved value at boot. Without this the
// brightness always powered up at the hardcoded backend default (25%).
static constexpr char BRIGHTNESS_KEY[] = "blpct";

esp_err_t brightness_save(int percent) {
    if (percent < 0) percent = 0;
    if (percent > 100) percent = 100;
    nvs_handle_t nvs = 0;
    esp_err_t err = nvs_open(IDLE_CFG_NS, NVS_READWRITE, &nvs);
    if (err != ESP_OK) return err;
    err = nvs_set_u8(nvs, BRIGHTNESS_KEY, (uint8_t)percent);
    if (err == ESP_OK) err = nvs_commit(nvs);
    nvs_close(nvs);
    return err;
}

void brightness_load(void) {
    if (!waveshare_display_brightness_supported()) return;
    nvs_handle_t nvs = 0;
    if (nvs_open(IDLE_CFG_NS, NVS_READONLY, &nvs) != ESP_OK) return;
    uint8_t percent = 0;
    if (nvs_get_u8(nvs, BRIGHTNESS_KEY, &percent) == ESP_OK) {
        if (percent > 100) percent = 100;
